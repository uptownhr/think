...
class OT_Admin
{
  ...
  function option_tree_admin() 
  {
    ...
    if ( $this->has_xml == true && $this->show_docs == false )
    {
      ...
      add_object_page( 'Corvius Theme', 'Corvius Theme', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ), OT_PLUGIN_URL.'/assets/images/icon_dark.png');
      $option_tree_options = add_submenu_page( 'option_tree', 'Corvius Theme', 'Theme Options', 'edit_theme_options', 'option_tree', array( $this, 'option_tree_options_page' ) );
      $option_tree_docs = add_submenu_page( 'option_tree', 'Corvius Theme', 'Newsletter', 'edit_theme_options', 'newsletter', 'rb_newsletter_admin' );
    ...
    else
    {
      ...
      $icon = OT_PLUGIN_URL.'/assets/images/icon_dark.png';
  ...
  function option_tree_notice_post_locked( $post_id ) 
  {
    ...
    $last_user_name = $last_user ? $last_user->display_name : __('Somebody', 'starkers');
    $the_page = ( $_GET['page'] == 'option_tree' ) ? __('Theme Options', 'starkers') : __('Settings', 'starkers');
    
    $message = sprintf( __( 'Warning: %s is currently editing the %s.', 'starkers' ), esc_html( $last_user_name ), $the_page );
